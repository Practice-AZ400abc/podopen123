          ...
          <div className="grid gap-2">
            ...
            <div className="p-4">
              <p className="text-sm font-normal text-start">
                Lookvisa values your privacy and your trust is important to
                us. We use cookies to enhance your website experience. Some cookies
                are necessary to run the website. Others are optional: performance
                cookies show us how you use our website and features; functional
      ...
      <div className={cn("fixed z-[200] bottom-0 left-0 right-0 sm:left-4 sm:bottom-4 w-full sm:max-w-md duration-700", !isOpen ? "transition-[opacity,transform] translate-y-8 opacity-0" : "transition-[opacity,transform] translate-y-0 opacity-100", hide && "hidden")}>
        <div className="m-3 dark:bg-card bg-background border border-border rounded-lg">
          ...
          <div className="p-3 flex items-center gap-2 mt-2 border-t">
            ...
            <Button onClick={decline} className="w-full h-9 rounded-full bg-blue-500" variant="outline">decline</Button>
          </div>
        </div>
      </div>
    )
